...
```bash
# 基础训练
python train.py --data fire_smoke/data.yaml --weights yolov5s.pt --epochs 150 --batch-size 16

# 使用GPU训练（推荐）
python train.py --data fire_smoke/data.yaml --weights yolov5s.pt --epochs 150 --batch-size 16 --device 0
